...
public class ScreenMain extends JFrame {
    ...
    private JTextField fieldNome, fieldEmail, fieldLogradouro, fieldMunicipio, fieldNumero, fieldBairro, fieldTelefone, fieldComplemento, fieldCEP, fieldUF, fieldRG, fieldOrgEx, fieldCPF, fieldPais, fieldLadoUF;
    private JLabel lblNome, lblEmail, lblLogradouro, lblMunicipio, lblNumero, lblBairro, lblTelefone, lblComplemento, lblCEP, lblUF, lblOrgEx, lblCPF, lblRG, lblPais, lblTipo, lblTitulo, lblFornecedor, lblSit;
    private JButton btnConfirmar, btnExcluir, btnLimpar;
    private JCheckBox ativo, inativo, forn;
    ...
    private void Initialization(){
        ...
        fieldNumero.setBounds(180, 390, 200, altura);
        ...
        fieldBairro.setBounds(180, 430, 200, altura);
    ...
    //--------------------------- 2ª Coluna ------------------------------//
        ...
        lblComplemento.setBounds(390,390,150,altura);
        ...
        fieldComplemento.setBounds(550,390,430,altura);

        //Telefone
        lblTelefone = new JLabel("Telefone");
        lblTelefone.setBounds(390, 430, 150, altura);
        ...
        fieldTelefone.setBounds(550,430, 200, altura);
    ...
    //--------------------------- 3ª Coluna ------------------------------//
        ...
        fieldUF.setBounds(780,270,80,altura);
        fieldLadoUF = new JTextField("");
        fieldLadoUF.setBounds(870, 270,110, altura);
    //--------------------------------------------------------------------//
    //--------------------------- 4ª Coluna ------------------------------//
        //Fornecedor
        ...
        lblSit.setBounds(760, 430, 150, altura);
        ...
        ativo = new JCheckBox();
        ativo.setBounds(920, 430, 30, altura);
        inativo = new JCheckBox();
        inativo.setBounds(960, 430, 30, altura);
